...
<div class="row">
  <div class="col-md-10 mx-auto">
    ...
    <form action="store.artistas.php" method="POST" enctype="multipart/form-data">
      <div class="row my-3">
        <div class="col-md-12 mx-0 px-0">
          <div class="form">
            <input type="text" class="form-control" placeholder="Nome do artista" name="nome" required>
          </div>
        </div>
      </div>
      <div class="row my-3">
      ...
      <div class= "row my-2">
          ...
          <a href="<?= "lista.artistas.php"; ?>"><button class="btn btn-dark btn-lg btn-radius btn-shadow btn-form-3 mx-3" data-mdb-ripple-color="dark">Voltar</button></a>  
      </div> 
    </form>
    <span class="my-5">
      <br><br><br><br>
