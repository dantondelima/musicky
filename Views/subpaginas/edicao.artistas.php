...
<div class="row">
  <div class="col-md-10 mx-auto">
    ...
    <div class= "row my-2">
        ...
        <a href="<?= "http://".$_SERVER['SERVER_NAME']."/musicky/Views/subpaginas/lista.artistas.php"; ?>"><button class="btn btn-dark btn-lg btn-radius btn-shadow btn-form-2 mx-3" data-mdb-ripple-color="dark">Voltar</button></a>  
    </div>  
  </div>
</div>
