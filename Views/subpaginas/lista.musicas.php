    ...
    <div class="row my-3 row-align">
        ...
        <div class="col-md-11 mx-0 px-0">
          <div class="float-right">
            <a href="<?= "http://".$_SERVER['SERVER_NAME']."/musicky/Views/subpaginas/cadastro.musicas.php"; ?>"><button class="btn btn-dark btn-lg btn-radius btn-shadow" data-mdb-ripple-color="dark">Cadastrar música</button></a>
          </div>
        </div>
    </div>
    <div class="row my-3">
        ...
        <div class="card-categoria">
          <img src="https://mdbootstrap.com/img/new/standard/nature/184.jpg" class="card-img-top" alt="..."/>
            <div class="card-body">
              ...
              <a href="<?= "http://".$_SERVER['SERVER_NAME']."/musicky/Views/subpaginas/edicao.musicas.php"; ?>" class="btn btn-warning btn-artista my-3 mx-3">Editar</a>
