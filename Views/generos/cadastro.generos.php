...
<div class="row">
  <div class="col-md-10 mx-auto">
      ...
      <div class="col mx-0 px-0">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= "http://".$_SERVER['SERVER_NAME']."/musicky/Views/generos/lista.generos.php"; ?>">Gêneros</a></li>
    ...
    <form action="store.generos.php" method="POST">
      <div class="row my-3">
        <div class="col-md-12 mx-0 px-0">
            <div class="form">
              <input type="text" class="form-control" placeholder="Gênero" name="nome">
            </div>
        </div>
      </div>
      <div class= "row my-2">
